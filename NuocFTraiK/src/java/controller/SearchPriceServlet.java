...
public class SearchPriceServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
      DAO d = new DAO();
        String from_price_raw = request.getParameter("from_price");
        String to_price_raw = request.getParameter("to_price");
        ...
        try {
            price1 = Double.parseDouble(from_price_raw);
            price2 = Double.parseDouble(to_price_raw);
           
        } catch (Exception e) {
        }
        List<Product> listP = d.searchPrice(price1, price2);
        ...
        request.setAttribute("from_price", price1);
        request.setAttribute("to_price", price2);
