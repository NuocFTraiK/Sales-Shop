                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        ...
                        <div class="row tm-edit-product-row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                  <form action="add" class="tm-edit-product-form">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea  name="describe" class="form-control validate" rows="3" required></textarea>
                                    </div>
                                      <div class="form-group mb-3">
                                    ...
                                    <div class="row">
                                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                                            ...
                                            <input id="expire_date" name="origin" type="text" class="form-control validate"
                                        ...
                                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                                            ...
                                            <input id="" name="number" type="text" class="form-control validate" required />
                                        </div>
                                    </div>
